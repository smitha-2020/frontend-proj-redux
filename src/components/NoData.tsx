...
const NoData = () => {
    return (
        <>
            <Grid container spacing={0} direction="row" alignItems="center" justifyContent="center" style={{ minHeight: '84vh', minWidth: '100vw', color: 'lightgray',backgroundColor:'primary.main' }}>
